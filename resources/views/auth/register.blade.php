...
<input class="w-full h-12 px-4 rounded-xl border border-outline-variant bg-surface-container-low text-body-lg font-body-lg focus-ring transition-all placeholder:text-outline-variant" id="dob" name="dob" placeholder="DD/MM/YYYY" required="" type="text">
</div>
<!-- Gender -->
<div class="space-y-1.5">

...
<style>
        ...
        .sidebar-active {
            background-color: #254990 !important; /* primary-container */
...
<nav class="flex-1 space-y-1"><div class="mb-4 px-4">
...
<img alt="Producto" class="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDHV8wYRBhGumJ2Qc9GfTnpYGn24G1egd_3-SxWTLLAN-UZBk7Ap4NhEu7i1ki7ujcNimCVcnT69MvZMpPCXNyBwU3seNe8GvGSlapQ1zYcklGziEM3_dn49QeA8F2rgd-B8n_Qq353xm1HFfiEmjndjBt3LBesAKUklsKXbqGUm4xIp7fw0r6XEQ5IBilvlNbyRFM4rokaw2xz7xyFpMR0zyXo5MtIfpU9spzTl5QrXm9ulQ8NjFlHDcYpYk50LcZyEAvTE6ZCB-c">
</div>
<span class="font-semibold text-body-lg">Smartwatch Pro X</span>
</div>
</td>
<td class="px-6 py-4 font-body-sm">Carlos Mendoza</td>
<td class="px-6 py-4 text-right font-body-lg font-bold">$249.00</td>
<td class="px-6 py-4 text-center">
<span class="px-3 py-1 rounded-full bg-tertiary-fixed text-on-tertiary-fixed text-[10px] font-bold">ACTIVO</span>
</td>
<td class="px-6 py-4 text-right">
<button class="text-primary hover:bg-primary-fixed p-1 rounded-full"><span class="material-symbols-outlined">edit</span></button>
...
<div class="flex items-center gap-3">
<div class="w-12 h-12 rounded bg-surface-container-high overflow-hidden flex-shrink-0">
<img alt="Producto" class="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuATgHl5fJIYB0T3CxudSWA1gtSAjCmcnLTnMm_Xe7onW4PWEXQzHfF5gT0JzQ4jYVQo5xzsV7SPYPB4wR_ScW1oxJqc5lQlHqSbMZfwaQCQvvAol48Wb5IpgZbWtn2ebZCCZkKe9t-cs2ZAS8GC-9Yl9Bi9iK5T0mcwk5mYiqY6d-Qz6OtzPb1qLbatHWWTEiYtYkVsBNDMiNbSRULYlrVZzoFHRPiz5ef1WjfY4CqgaAQYa4vl0uLh118HRsb0Nf-WDltSUmvO5Jg">
</div>
<span class="font-semibold text-body-lg">Auriculares Bluetooth</span>
</div>
</td>
<td class="px-6 py-4 font-body-sm">Elena Torres</td>
<td class="px-6 py-4 text-right font-body-lg font-bold">$120.00</td>
<td class="px-6 py-4 text-center">
<span class="px-3 py-1 rounded-full bg-tertiary-fixed text-on-tertiary-fixed text-[10px] font-bold">ACTIVO</span>
</td>
<td class="px-6 py-4 text-right">
